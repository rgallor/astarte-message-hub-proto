...
class MessageHubResult(_message.Message):
    __slots__ = ("empty_message", "error")
    EMPTY_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    empty_message: _empty_pb2.Empty
    error: _message_hub_error_pb2.MessageHubError
    def __init__(self, empty_message: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ..., error: _Optional[_Union[_message_hub_error_pb2.MessageHubError, _Mapping]] = ...) -> None: ...
